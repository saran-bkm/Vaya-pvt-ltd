            ...
            <form>
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="product_name" id="product_name" onkeyup="validateName()">
                        <small id="err_name" class="text-danger d-none"></small>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Price</label>
                        <input type="text" class="form-control" name="price" id="price" onkeyup="validatePrice()">
                        <small id="err_price" class="text-danger d-none"></small>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Quantity</label>
                        <input type="text" class="form-control" name="qty" id="qty" onkeyup="validateQty()">
                        <small id="err_qty" class="text-danger d-none"></small>
                    </div>

                    <div class="col-md-12 d-flex justify-content-end mt-3">
                        <button class="btn btn-success" onclick="Add_product(event)">
                            Save Product
                        </button>
                    </div>
